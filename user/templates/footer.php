        ...
        <div class="row px-5 py-3">
            <div class="col-sm ">
                ...
                <p class="foot-item ml-3">
                    <a href="<?= url ?>user/produk.php/?kategori=ponsel">Gamis</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=laptop">Mukenah</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=ponsel">Tunik</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=ponsel">Rok</a><br>
                </p>
            </div>
            <div class="col-sm ">
                <h6>Halaman</h6>
