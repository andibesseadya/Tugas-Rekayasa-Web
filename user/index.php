...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= url ?>assets/images/pages/diskon1.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?= url ?>assets/images/pages/diskon3.jpg" class="d-block w-100" alt="...">
        </div>
    </div>
</div>
...
<div class="row bg-light my-5 p-3" style="margin: 0 -50px">
    <div class="col">
        ...
        <div class="d-flex w-100">
            <img class="w-100" src="<?= url ?>assets/images/pages/muslimah1.jpg" alt="">
            <img class="w-100" src="<?= url ?>assets/images/pages/mukenah2.jpg" alt="">
        </div>
    </div>
</div>
    ...
    <div class="produk-front border-top bg-light">
        <?php foreach ($produk as $value) : ?>
            <div class="col-md-2 card-produk shadow-sm m-1  bg-white">
                <div class="card-img" style=" height:55%;">
